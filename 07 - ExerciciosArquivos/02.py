...
def main():
    ...
    for i in usuario_espaco:
        percentual = calcular_percentual(i[1],megabytes)
    ...
    with open('relatório.txt', 'a',encoding="utf-8") as arquivo:
        ...
        print(f"Espaço médio ocupado: {megabytes/len(usuario_espaco):.2f} MB", file=arquivo)

def bytes_megabytes(bytes):
    return round(bytes/1024/1024,2)

def calcular_percentual(utilizado_pelo_usuario,megabytes):
